"""
Django settings for rice_39992 project.
...
WSGI_APPLICATION = 'rice_39992.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rice_39992 API",
    "DESCRIPTION": "API documentation for rice_39992 App",
    "VERSION": "v1",
}
